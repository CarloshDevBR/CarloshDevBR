...
[![Minhas Habilidades](https://skillicons.dev/icons?i=html,css,js,ts,react,nextjs,vite,styledcomponents,flutter,dart,docker,figma,materialui,git,bash,github,vscode)](https://skillicons.dev)
